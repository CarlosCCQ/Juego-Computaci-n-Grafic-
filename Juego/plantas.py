...
def decoraciones_planta():
    ...
    decoraciones_sprites = {
        0: pygame.image.load(ruta_base +"/scripts/nivel/plantas/arbol (0).png"),
        1: pygame.image.load(ruta_base +"/scripts/nivel/plantas/arbol (1).png"),
        2: pygame.image.load(ruta_base +"/scripts/nivel/plantas/arbol (2).png"),
        3: pygame.image.load(ruta_base +"/scripts/nivel/plantas/arbol (3).png"),
        6: pygame.image.load(ruta_base +"/scripts/nivel/plantas/arbol (6).png"),
    }
...
def cargar_decoraciones_planta():
    ruta_base = os.path.dirname(__file__)
    ruta_csv = os.path.join(ruta_base + "/scripts/juego_csv/plantas.csv")
    decoraciones = []
